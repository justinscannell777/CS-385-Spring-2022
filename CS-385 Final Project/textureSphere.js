...
function textureSphere( slices, stacks, vertexShader, fragmentShader ) { 
    let i, j;  // loop counters

    let program = initShaders(gl,
        vertexShader || "Texture-Sphere-vertex-shader",
        fragmentShader || "Texture-Sphere-fragment-shader");
    ...
    textureCoordinates.numComponents = 2;
    ...
    gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(positions),
        gl.STATIC_DRAW);
    textureCoordinates.buffer = gl.createBuffer();
    gl.bindBuffer(gl.ARRAY_BUFFER, textureCoordinates.buffer);
    ...
    var aTextureCoordinates = gl.getAttribLocation(program, "aTextureCoordinates");
    ...
    this.render = function () {
        ...
        gl.bindBuffer(gl.ARRAY_BUFFER, textureCoordinates.buffer);
        gl.vertexAttribPointer(aTextureCoordinates, textureCoordinates.numComponents,
            gl.FLOAT, gl.FALSE, 0, 0);
        ...
        if (tex) {gl.uniform1i(tex, this.tex); }
